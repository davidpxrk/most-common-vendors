...
date: today
date-format: long
abstract: "This paper analyzes the Canadian Grocery Price data from Canadian groceryvendors, which was gathered by Jacob Filipp and hosted publicly by Project Hammer. It uses information on items, and the name of vendors to determine how many vendors hold a unique grocery item. It was discovered that expenses exceeded income for most families (meaning low-income families were not able to make ends meet in Toronto), and rent, food costs were among the highest expenses. This finding is important as it can allow more competition, hence, cooling down prices for these unique goods."
format: pdf
toc: true
