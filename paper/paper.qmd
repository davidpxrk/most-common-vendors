...
This report uses the Canadian Grocery Price dataset, gathered by Jacob Filipp and hosted by Project Hammer [@citedprojecthammer]. The dataset, contained 3 different tables, but the `product` table was specificially used for this analysis, as the other 2 tables were of no relevance.
